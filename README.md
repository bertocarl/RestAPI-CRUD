...
## Use
We can test the API using [curl](https://curl.haxx.se/). Httpie is a user friendly http client that's written in Python. Let's install that.
...
```
	http http://127.0.0.1:8000/rest-auth/login/ username="admin" password="admin@2021"
```
after that, we get the token
```
{
    "key": "1d48f1d8069ce41ed6bc22468e2ce0077fa16f12"
}
```
